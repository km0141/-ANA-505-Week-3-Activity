...
getwd()
setwd("C:/Users/Katherine Martinez/Documents")
...
Katherine_df = data.frame(Titanic)
print(Katherine_df)
...
sex_col = Katherine_df["Sex"]

age_col = Katherine_df["Age"]
...
new_df = data.frame(sex_col, age_col)
...
ggplot(Katherine_df, aes(Survived, Freq)) +
  geom_col()
